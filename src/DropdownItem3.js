...
function DropdownItem3() {
  let [onews, setOnews] = useState([])

  

  useEffect(()=>{
          axios.get("https://newsapi.org/v2/everything?q=bitcoin&apiKey=e7d8d2601f1b4cd7bfe450b4543cc9be").then((res) => {
            console.log(res.data.articles)
            setOnews(res.data.articles)
          })
        }, [])
  return (
    <>
